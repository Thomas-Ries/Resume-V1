...
<body>
    ...
    <div class="main-container">
        ...
        <div class="navbar">
            ...
            <a href="#" id="top"> <input class="cv-btn" type="button" value="CV PDF"> </a>
        </div>


        <!-- START NAV TITLE -->
        <img class ="imgAurore" src="../img/northern-lights.jpg" alt="northern lights picture" title="northern lights picture">
        <img class="imgMountains" src="../img/mountains.jpg" alt="moutains picture" title="moutains picture" height="820" width="375">
        ...
        <div class="socialIcons">
            <a href="https://github.com/Thomas-Ries" target="blank"><img class ="git" src="../icones/github.png" alt="lien Github" title="lien Github"></a>
            <a href="https://fr.linkedin.com/in/thomas-ries-balsamo-24116410b" target="blank"><img src="../icones/linkedin.png" alt="lien Linkedin" title="lien Linkedin"></a>
            <a href="https://twitter.com/nom_dune_banane" target="blank"><img src="../icones/twitter.png" alt="lien Twitter" title="lien Twitter"></a>
            <a href="https://www.instagram.com/de_la_a_de_la/" target="blank"><img src="../icones/instagram.png" alt="lien Instagram" title="lien Instagram"></a>
        </div>
        <!-- END SOCIAL ICONS -->
        ...
        <div class="imgDescription">
            ...
            <br>
                ...
                <a href="mailto:thomasries.dev@gmail.com"> <input class="contact-btn" type="button" value="Contactez-moi par mail"> </a>
            </div>
        </div>
...
<!-- START EXPERIENCES PROFESSIONNELLES -->
    <div class="experiences" id="experiences">
        <h3> <i class="fas fa-atom"></i></i>03. Expériences Professionnelles Significatives </h3> 
...
<!-- END EXPERIENCES PROFESSIONNELLES -->
    ...
    <div class="contact-container" id="contact">
      <h3> <i class="far fa-bookmark"></i> 05. Contact </h3> 
      <br>
    <div class="contactPosition" id="contact">
      <div class="identite">
